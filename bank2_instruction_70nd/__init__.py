...
class C(BaseConstants):
    NAME_IN_URL = 'bank2_instruction_70nd'
    PLAYERS_PER_GROUP = 2
    NUM_ROUNDS = 1
    PART1_ROUNDS = 10
...
page_sequence = [Welcome, Intro1, Intro2, Intro3Low, Intro3High, Intro3Med, Intro3Unknown, Intro4OtherBank, Intro5Correlation, Intro6, Intro7,
                 WaitForAll,
